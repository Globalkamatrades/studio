...
import { LayoutDashboard, BarChart2, Settings, Gift, ShieldCheck, Wallet, AlertTriangle } from 'lucide-react';
          ...
          <>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <CardContent>
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground">(Live balance coming soon)</p>
                    </div>
                    <div>
                      <p className="text-sm text-muted-foreground">My NFTs:</p>
                      <p className="text-2xl font-semibold text-primary">0 NFTs</p>
                      <p className="text-xs text-muted-foreground">(Live count coming soon)</p>
                    </div>
                    <div>
              ...
              <Card className="shadow-lg hover:shadow-xl transition-shadow md:col-span-2 lg:col-span-3">
                ...
                <CardContent>
                  <p className="text-muted-foreground">Your connected wallet address:</p>
