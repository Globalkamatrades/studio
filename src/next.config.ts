...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const cspDirectives = [
      ...
      "connect-src 'self' https://eth-mainnet.g.alchemy.com https://developer.api.us.stg.walmart.com https://blockchain.googleapis.com wss://blockchain.googleapis.com", // For Alchemy, Walmart & Blockchain Node Engine APIs
